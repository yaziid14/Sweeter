...
MONGODB_CONNECTION_STRING = 'mongodb+srv://azharyazied2:14juni2002@cluster0.4uh4rdq.mongodb.net/?retryWrites=true&w=majority'
...
def home():
    ...
    try:
        ...
        return redirect(url_for("login", msg="Token Kaldaruarsa"))
    except jwt.exceptions.DecodeError:
        return redirect(url_for("login", msg="Silahkan login terlebih dahulu"))
...
def get_posts():
    ...
    try:
        ...
        for post in posts:
            ...
            post["count_bookmark"] = db.likes.count_documents({"post_id": post["_id"], "type": "bookmark"})
            post["bookmark_by_me"] = bool(db.likes.find_one({"post_id": post["_id"], "type": "bookmark", "username": payload["id"]}))
        return jsonify(
            {
                "result": "success",
